...
.method private b(Landroid/arch/lifecycle/e;)V
    ...
    new-instance v1, Landroid/arch/a/b/b$b;

    iget-object v2, v0, Landroid/arch/a/b/b;->c:Landroid/arch/a/b/b$c;

    iget-object v3, v0, Landroid/arch/a/b/b;->b:Landroid/arch/a/b/b$c;

    invoke-direct {v1, v2, v3}, Landroid/arch/a/b/b$b;-><init>(Landroid/arch/a/b/b$c;Landroid/arch/a/b/b$c;)V
    ...
    invoke-direct {p0, v4}, Landroid/arch/lifecycle/f;->b(Landroid/arch/lifecycle/c$b;)V
...
.method private b()Z
    ...
    iget-object v2, v2, Landroid/arch/a/b/b;->c:Landroid/arch/a/b/b$c;
...
.method private c(Landroid/arch/lifecycle/d;)Landroid/arch/lifecycle/c$b;
    ...
    invoke-static {v0, p1}, Landroid/arch/lifecycle/f;->a(Landroid/arch/lifecycle/c$b;Landroid/arch/lifecycle/c$b;)Landroid/arch/lifecycle/c$b;

    move-result-object p1

    invoke-static {p1, v2}, Landroid/arch/lifecycle/f;->a(Landroid/arch/lifecycle/c$b;Landroid/arch/lifecycle/c$b;)Landroid/arch/lifecycle/c$b;
...
.method public final a(Landroid/arch/lifecycle/c$a;)V
    ...
    invoke-virtual {p0, p1}, Landroid/arch/lifecycle/f;->a(Landroid/arch/lifecycle/c$b;)V
...
.method public final a(Landroid/arch/lifecycle/d;)V
    ...
    invoke-static {v4}, Landroid/arch/lifecycle/f;->c(Landroid/arch/lifecycle/c$b;)Landroid/arch/lifecycle/c$a;
