...
.method public static parse(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    .locals 3
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation

    :cond_0
    invoke-interface {p0}, Lorg/d/a/a;->j()I
    ...
    invoke-static {p0, p1}, Landroid/support/v4/content/res/FontResourcesParserCompat;->readFamilies(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
...
.method private static readFamilies(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    .locals 3
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
    ...
    invoke-interface {p0, v2, v1, v0}, Lorg/d/a/a;->a(ILjava/lang/String;Ljava/lang/String;)V

    invoke-interface {p0}, Lorg/d/a/a;->f()Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Landroid/support/v4/content/res/FontResourcesParserCompat;->readFamily(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    ...
    :cond_0
    invoke-static {p0}, Landroid/support/v4/content/res/FontResourcesParserCompat;->skip(Lorg/d/a/a;)V

    return-object v1
.end method

.method private static readFamily(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FamilyResourceEntry;
    .locals 8
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation

    invoke-static {p0}, Landroid/util/Xml;->asAttributeSet(Lorg/d/a/a;)Landroid/util/AttributeSet;
    ...
    invoke-interface {p0}, Lorg/d/a/a;->i()I
    ...
    invoke-static {p0, p1}, Landroid/support/v4/content/res/FontResourcesParserCompat;->readFont(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;
...
.method private static readFont(Lorg/d/a/a;Landroid/content/res/Resources;)Landroid/support/v4/content/res/FontResourcesParserCompat$FontFileResourceEntry;
    .locals 5
...
.method private static skip(Lorg/d/a/a;)V
    .locals 2
