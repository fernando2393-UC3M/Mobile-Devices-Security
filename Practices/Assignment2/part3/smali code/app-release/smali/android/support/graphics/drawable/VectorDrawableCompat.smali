...
.method public static create(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    invoke-static {p1}, Landroid/util/Xml;->asAttributeSet(Lorg/d/a/a;)Landroid/util/AttributeSet;
    ...
    invoke-static {p0, p1, v0, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat;->createFromXmlInner(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/graphics/drawable/VectorDrawableCompat;
    ...
    :cond_3
    new-instance p0, Lorg/d/a/b;

    const-string p1, "No start tag found"

    invoke-direct {p0, p1}, Lorg/d/a/b;-><init>(Ljava/lang/String;)V
...
.method public static createFromXmlInner(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/support/graphics/drawable/VectorDrawableCompat;
    .locals 1
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Landroid/support/graphics/drawable/VectorDrawableCompat;->inflate(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V

    return-object v0
.end method

.method private inflateInternal(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    .locals 9
    ...
    invoke-interface {p2}, Lorg/d/a/a;->i()I

    move-result v3

    invoke-interface {p2}, Lorg/d/a/a;->a()I
    ...
    invoke-interface {p2}, Lorg/d/a/a;->f()Ljava/lang/String;
    ...
    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat$VFullPath;->inflate(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/d/a/a;)V
    ...
    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat$VClipPath;->inflate(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/d/a/a;)V
    ...
    invoke-virtual {v3, p1, p3, p4, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat$VGroup;->inflate(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/d/a/a;)V
    ...
    :cond_7
    :goto_2
    invoke-interface {p2}, Lorg/d/a/a;->j()I
    ...
    :cond_9
    new-instance p1, Lorg/d/a/b;

    const-string p2, "no path defined"

    invoke-direct {p1, p2}, Lorg/d/a/b;-><init>(Ljava/lang/String;)V
...
.method private updateStateFromTypedArray(Landroid/content/res/TypedArray;Lorg/d/a/a;)V
    .locals 5
    ...
    invoke-static {p1, p2, v2, v3, v4}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedInt(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;II)I
    ...
    invoke-static {p1, p2, v2, v3, v4}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedBoolean(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;IZ)Z
    ...
    invoke-static {p1, p2, v0, v2, v3}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;IF)F
    ...
    invoke-direct {p2, p1}, Lorg/d/a/b;-><init>(Ljava/lang/String;)V
...
.method public inflate(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/graphics/drawable/Drawable;->inflate(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroid/support/graphics/drawable/VectorDrawableCompat;->inflate(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V

    return-void
.end method

.method public inflate(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    .locals 2
    ...
    invoke-static {v0, p1, p2, p3, p4}, Landroid/support/v4/graphics/drawable/DrawableCompat;->inflate(Landroid/graphics/drawable/Drawable;Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-direct {p0, v1, p2}, Landroid/support/graphics/drawable/VectorDrawableCompat;->updateStateFromTypedArray(Landroid/content/res/TypedArray;Lorg/d/a/a;)V
    ...
    invoke-direct {p0, p1, p2, p3, p4}, Landroid/support/graphics/drawable/VectorDrawableCompat;->inflateInternal(Landroid/content/res/Resources;Lorg/d/a/a;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
