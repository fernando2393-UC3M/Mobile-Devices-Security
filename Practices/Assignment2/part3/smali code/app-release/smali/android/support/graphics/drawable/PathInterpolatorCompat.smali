...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lorg/d/a/a;)V
    .locals 1
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Landroid/support/graphics/drawable/PathInterpolatorCompat;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/d/a/a;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/d/a/a;)V
    .locals 1
    ...
    invoke-direct {p0, p1, p4}, Landroid/support/graphics/drawable/PathInterpolatorCompat;->parseInterpolatorFromTypeArray(Landroid/content/res/TypedArray;Lorg/d/a/a;)V
...
.method private parseInterpolatorFromTypeArray(Landroid/content/res/TypedArray;Lorg/d/a/a;)V
    .locals 6

    const-string v0, "pathData"

    invoke-static {p2, v0}, Landroid/support/v4/content/res/TypedArrayUtils;->hasAttribute(Lorg/d/a/a;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v0, v1}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedString(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2, v0, v1, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, v3, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;IF)F

    move-result v1

    const-string v3, "controlX2"

    invoke-static {p2, v3}, Landroid/support/v4/content/res/TypedArrayUtils;->hasAttribute(Lorg/d/a/a;Ljava/lang/String;)Z

    move-result v3

    const-string v4, "controlY2"

    invoke-static {p2, v4}, Landroid/support/v4/content/res/TypedArrayUtils;->hasAttribute(Lorg/d/a/a;Ljava/lang/String;)Z
    ...
    invoke-static {p1, p2, v3, v4, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v4, v5, v2}, Landroid/support/v4/content/res/TypedArrayUtils;->getNamedFloat(Landroid/content/res/TypedArray;Lorg/d/a/a;Ljava/lang/String;IF)F
